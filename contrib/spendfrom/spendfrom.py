...
def determine_db_dir():
    """Return the default location of the credits data directory"""
...
def connect_JSON(config):
    """Connect to a credits JSON-RPC server"""
...
def main():
    ...
    parser.add_option("--from", dest="fromaddresses", default=None,
                      help="addresses to get creditss from")
    parser.add_option("--to", dest="to", default=None,
                      help="address to get send creditss to")
