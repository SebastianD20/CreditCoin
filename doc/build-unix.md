UNIX BUILD NOTES
====================
Some notes on how to build Credits Core in Unix.
...
memory available when compiling Credits Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Credits Core without wallet.
...
As mentioned above, when maintaining portability of the wallet between the standard Credits Core distributions and independently built
...
with 4.8-built Credits Core is needed follow the steps under "Berkeley DB" above.
